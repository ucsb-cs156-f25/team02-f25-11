...
public class UCSBDiningCommonsMenuItemWebIT extends WebTestCase {
  ...
  public void admin_user_can_create_edit_delete_menu_item() throws Exception {
    ...
    page.getByTestId("UCSBDiningCommonsMenuItemForm-name").fill("food1");
    page.getByTestId("UCSBDiningCommonsMenuItemForm-diningCommonsCode").fill("ortega");
    page.getByTestId("UCSBDiningCommonsMenuItemForm-station").fill("station1");
    ...
    page.getByTestId("UCSBDiningCommonsMenuItemForm-diningCommonsCode").fill("THE BEST");
    page.getByTestId("UCSBDiningCommonsMenuItemForm-submit").click();

    assertThat(page.getByTestId("UCSBDiningCommonsMenuItemTable-cell-row-0-col-diningCommonsCode")).hasText("THE BEST");
