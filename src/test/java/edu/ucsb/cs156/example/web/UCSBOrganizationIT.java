...
public class UCSBOrganizationIT extends WebTestCase {
  ...
  public void admin_user_can_create_edit_delete_organization() throws Exception {
    ...
    page.getByTestId("UCSBOrganizationForm-orgCode").fill("TSTORG");
    page.getByTestId("UCSBOrganizationForm-orgTranslationShort").fill("Test Org Short Name");
    page.getByTestId("UCSBOrganizationForm-orgTranslation").fill("Test Organization Full Name");
    page.getByTestId("UCSBOrganizationForm-inactive").click();
    ...
    assertThat(page.getByTestId("UCSBOrganizationTable-cell-row-0-col-orgTranslation"))
        .hasText("Test Organization Full Name");
    ...
    page.getByTestId("UCSBOrganizationForm-orgTranslation").fill("UPDATED ORGANIZATION NAME");
    page.getByTestId("UCSBOrganizationForm-submit").click();

    assertThat(page.getByTestId("UCSBOrganizationTable-cell-row-0-col-orgTranslation"))
        .hasText("UPDATED ORGANIZATION NAME");
